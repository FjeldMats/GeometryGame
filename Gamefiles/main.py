...
if __name__ == "__main__":
    ...
    background = randomGeneratedBackground(
        width, height, pygame.Color("white"))
    ...
    while not done:
        ...
        pygame.draw.line(screen, pygame.Color(
            "red"), (player.x, player.y), (mouse_pos[0],  mouse_pos[1]), 2)
        ...
        if now - last_enemy_spawn > enemy_spawn_cooldown:
            ...
            enemies.append(Enemy(x, y, size*5, 15/size,
                           size, (255, 0, 0), player))
            last_enemy_spawn = pygame.time.get_ticks()

            enemy_spawn_cooldown = random.randint(
                1000 - (score * 10), 6000 - (score * 100))
        ...
        score_text = font.render(
            "Score: " + str(score), 2, pygame.Color("coral"))
